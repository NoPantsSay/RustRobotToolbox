  ...
  return (
    <Popover>
      <PopoverButton
        ...
        className="flex gap-2 px-3 py-2.5 items-center hover:bg-hover-background focus:not-data-focus:outline-none cursor-pointer"
      >
        <SlGlobe size={20} />
                    ...
                    <ComboboxOption
                      ...
                      className={clsx(
                        ...
                        option.timeZone === timeZone
                          ? "bg-scheme-background data-focus:bg-scheme-hover-background"
                          : "data-focus:bg-hover-background",
                        {
